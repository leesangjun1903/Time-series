...
# 1. 당신은 AI 분야의 연구자입니다. "Temporal Pattern Attention for Multivariate Time Series Forecasting"의 핵심 주장과 주요 기여를 간결하게 요약하세요.
...
1번은 한국어로, 2–4번은 연구자 관점에서 조금 더 자세히 정리하되, 모두 LaTeX 수식에 달러 기호를 사용하겠습니다.
