...
6. 본 학습자료는 Recipe 1-2 “Saving Time Series Objects”의 원문을 출발점으로 하되, 대학원 수준의 수학적 정의와 2020년 이후 연구를 연결합니다.
...
저자는 시계열 DataFrame을 CSV로 저장하고 다시 읽는 가장 기본적인 persistence 절차를 설명합니다.

이 문단은 **저자의 보고를 요약한 것**이며, 아래의 비판적 해석과 구분해야 합니다.

## 5. 비판적 해석 및 연구자 관점

저장 포맷 선택은 재현성, dtype 보존, 용량, schema evolution까지 포함하는 데이터 엔지니어링 문제입니다.
...
CSV 저장은 dtype, timezone, frequency metadata를 완전히 보존하지 않을 수 있습니다. 연구 재현성에는 schema와 버전 정보를 함께 보존해야 합니다.
