# Recipe 1-4C. Time Series Components — Seasonality (continued)

> 학습 수준: **대학/대학원 → 연구자 발전형**  
> 원문 위치: **PDF 33–36 / book pp.18–21**  
...
6. 본 학습자료는 Recipe 1-4C “Time Series Components — Seasonality (continued)”의 원문을 출발점으로 하되, 대학원 수준의 수학적 정의와 2020년 이후 연구를 연결합니다.
...
저자는 tractor sales에서 상승 trend와 강한 월별 계절성이 함께 존재함을 시각적으로 보여줍니다.

이 문단은 **저자의 보고를 요약한 것**이며, 아래의 비판적 해석과 구분해야 합니다.

## 5. 비판적 해석 및 연구자 관점

증가 trend와 계절 진폭 증가가 함께 보이면 multiplicative 또는 variance-stabilizing transform을 검토할 가치가 있습니다.
